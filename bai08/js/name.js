...
document.write("Trong tên của bạn có:" +dem , "chữ n");
document.write('<br>');
// cau3
...
document.write("Trong tên của bạn có " +count , " ký tự");
document.write('<br>');
a = firstName.length;
b = secondName.length;
c = lastName.length;
var cau4b = a + b + c;
document.write("Trong tên của bạn có " +cau4b,"ký tự không tính khoảng trống");
document.write('<br>');
//cau 5
